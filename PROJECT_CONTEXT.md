...
8. Deploy and configure the two-repository BlendSign lease integration, run both disposable debit-order and non-debit send→sign→activate journeys, then add completed-PDF/certificate retrieval plus retry/reconciliation UI.
