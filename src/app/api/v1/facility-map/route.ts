...
const elementSchema = z.object({
  id: z.string().min(1).max(100), type: z.enum(["UNIT", "ZONE", "WALL", "FIRE_WALL", "DOOR", "WINDOW", "LABEL", "ROLLER_SHUTTER", "SINGLE_DOOR", "DOUBLE_DOOR", "STAIRS", "LIFT", "TABLE", "CHAIR", "CUPBOARD"]),
